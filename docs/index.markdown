...
<div markdown="1">
[Démarrage rapide](pages/guide/version-2/getting-started/get-api-key.html){:class="btn  btn--style1"}
</div>
</div>
    ...
    <div class="border rounded col p-2 m-1">
        ...
        <div>
            <ul>
                ...
                <li>Vérifier l'identité du professionnel (identifiant national, nom, prénom), les qualifications et la situation d’exercice d'un professionnel</li>
    ...
    <div class="border rounded col p-2 m-1">
        ...
        <div>
            <ul>
                ...
                <li>Consulter les activités d'un professionnel (comme l’adresse du lieu d'exercice) à partir de son identifiant national</li>
            </ul>
        </div>
    </div>
    <div class="border rounded col p-2 m-1">
