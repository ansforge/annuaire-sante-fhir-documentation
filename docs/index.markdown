...
ATTENTION| Cette documentation est en cours de rédaction. Veuillez ne pas l'utiliser pour des développement de production.

Trouvez ici tous les guides d'implémentation des nouveaux services FHIR d'IRIS-DP.

## Quick start

Démarrez rapidement avec l'API IRIS-DP. 
...
<div class="row">
    ...
    <div class="col col-12 col-md-3">
        ...
        <span  class="doc-section-title"><a href="https://portail.openfhir.annuaire.sante.fr/" target="_blank">IHM FHIR : </a></span>
