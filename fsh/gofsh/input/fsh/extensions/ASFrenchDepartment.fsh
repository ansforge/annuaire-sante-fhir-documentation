Extension: ASFrenchDepartment
Id: as-french-department
Description: "Département français"
* ^url = "http://interop.esante.gouv.fr/fhir/ig/as10/StructureDefinition/as-french-department"
...
* url = "http://interop.esante.gouv.fr/fhir/ig/as10/StructureDefinition/as-french-department" (exactly)
